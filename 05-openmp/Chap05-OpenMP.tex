...
\begin{frame}{Alternatives}
  ...
  \begin{itemize}
    ...
    \item OpenMP permet de paralléliser un programme séquentiel graduellement avec une granularité très fine, et même à partir de 4.0 d'utiliser le GPU.
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Les pragmas}
  ...
  \begin{itemize}
    \item Syntaxe: \verb|#pragma omp directive [clause...]|
    
    \item En C++ 11 ce peut être: \verb|[[ omp :: directive( directive-name, clause...) ]]|
    ...
    \item Clauses: shared, private, firstprivate, lastprivate, default, reduction, copyin, if, order, ordered, schedule, nowait, safelen, linear, aligned, collapse, device, map, num\_threads, proc\_bind, ...
% allocate, filter, num\_teams, thread\_limit, uniform, untied, mergeable, in\_reduction, depend, detach.
  \end{itemize}
\end{frame}
...
% https://ecpannualmeeting.com/assets/overview/sessions/ff2020%20ECP-Tutorial-with-ECP-template.pdf
% https://developers.redhat.com/blog/2021/05/03/new-features-in-openmp-5-0-and-5-1#openmp_5_1_features
